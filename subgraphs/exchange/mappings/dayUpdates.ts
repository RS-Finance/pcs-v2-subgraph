...
import { Pair, Bundle, Token, KsfswapFactory, KsfswapDayData, PairDayData, TokenDayData } from "../generated/schema";
import { ONE_BI, ZERO_BD, ZERO_BI, FACTORY_ADDRESS } from "./utils";

export function updateKsfswapDayData(event: ethereum.Event): KsfswapDayData {
  ...
  ksfswapDayData.totalTransactions = ksfswap.totalTransactions;
  ksfswapDayData.save();
